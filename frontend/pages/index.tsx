      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
            <div>
              <h1 style={{ margin: 0, fontSize: '28px', color: '#333' }}>Event Media Upload</h1>
              <p style={{ margin: '5px 0 0 0', color: '#666' }}>Scan QR → Upload Photos</p>
            </div>
          ...
          <button
            ...
            style={{
              ...
              padding: '12px',
              fontSize: '16px',
              backgroundColor: files.length > 0 && !uploading ? '#0070f3' : '#ccc',
              color: 'white',
              border: 'none',
              borderRadius: '5px',
